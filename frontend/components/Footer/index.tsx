                ...
                <Link href="/" className="mb-8 inline-block">
                  <div className="flex flex-row items-center ">
                    <img
                      ...
                      alt=""
                    />
                    <h1 className="{kanit.className} kanit pl-4 font-extrabold text-indigo dark:text-white">
                      LegalWiseAI
                    </h1>
                  </div>
                </Link>
                <p className="text-body-color mb-9 text-base font-medium leading-relaxed">
                  Simplifying and streamlining legal documentation for all
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://legislative.gov.in/about-department/about-the-department/"
                      className="text-body-color mb-4 inline-block text-base font-medium hover:text-primary"
                    >
                      {" "}
